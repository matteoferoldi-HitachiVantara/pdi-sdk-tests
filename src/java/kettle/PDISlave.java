...
public class PDISlave extends PDIBaseObject {
  ...
  public void save( Repo repo ) {
    ...
    LOGGER.info( "Slave server " + name + " (hostname: " + slaveServer.getHostname() + ", port:" + slaveServer.getPort()
        + ", username: " + slaveServer.getUsername() + ", password: " + slaveServer.getPassword() + ") created" );
  }

...
public class AddSequenceStep extends AbstractStep {
  ...
  public AddSequenceStep( HashMap<String, String> args ) {
    this( args.get( "stepName" ), args.get( "valueName" ), args.get( "counterName" ),
        Long.valueOf( args.get( "startAt" ) ), Long.valueOf( args.get( "maxValue" ) ),
        Long.valueOf( args.get( "increment" ) ), Integer.valueOf( args.get( "posX" ) ),
        Integer.valueOf( args.get( "posY" ) ) );
  }
